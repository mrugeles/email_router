...
print("Instantiating RAGKnowledgePromptAgent...")
RAG_knowledge_prompt_agent = RAGKnowledgePromptAgent(
    openai_api_key=openai_api_key,
    persona=persona,
    chunk_size=1000,       # optional tuning
    chunk_overlap=100
...
print("Computing knowledge text chunks and embeddings...")
chunks = RAG_knowledge_prompt_agent.chunk_text(knowledge_text)
print("Knowledge text chunks computed.")
print("Calculating embeddings for the chunks...")
...
print("Finding response in knowledge...")
